...
class VBFTransformerRegressionDataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        self.__plot_distributions(X_train, left_tail_ind, right_tail_ind, stage="Raw_Data", scaled=False) # Plot data before scaling
        ...
        self.__plot_distributions(X_train, left_tail_ind, right_tail_ind, stage="Scaled_Data", scaled=True) # Plot data after scaling
    ...
    def train_dataloader(self):
        return DataLoader(self.train_dataset, batch_size=self.train_batch_size, shuffle=True, num_workers=15, persistent_workers=True, drop_last=True, pin_memory=True)

    def val_dataloader(self):
        return DataLoader(self.val_dataset, batch_size=self.val_batch_size, shuffle=False, num_workers=15, persistent_workers=True, drop_last=True, pin_memory=True)
    ...
    def __plot_distributions(self, X, left_tail_ind, right_tail_ind, stage="Raw_Data", scaled=False):
